...
error_reporting(0);
        ...
        $res = mysqli_query($conn , "SELECT * FROM booking WHERE Triptype='$Triptype'")
?>
<!DOCTYPE html>
    <html lang="en">
    <head>
...
<form method="post" action="">
	<label>Search by Triptype:</label> 
	<input type="text" name="Triptype" placeholder="Enter Triptype">
